...
/**
 * This is MainActivity. From this activity we can select smartwatchUi and information
 */

public class HelloNotificationPreferenceActivity extends Activity {
    ...
    private SharedPreferences getGCMPreferences(Context context) {
  	  // This sample app persists the registration ID in shared preferences, but
  	     ...
  	     return getSharedPreferences(HelloNotificationPreferenceActivity.class.getSimpleName(),
